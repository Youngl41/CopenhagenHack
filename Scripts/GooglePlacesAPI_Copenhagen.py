...
#    # Request place IDs
    results_nearby_search = Parallel(n_jobs = ncores)(delayed(results_nearby_search_wrapper)(circles.iloc[i], api_keys, type_list = ['museum', 'amusement_park', 'art_gallery', 'aquarium', 'park']) for i in range(len(circles)))
