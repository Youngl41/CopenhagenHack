...
# -*- coding: utf-8 -*-
"""
Created on Mon Jun  4 20:45:16 2018
...
crowdy_pdf = crowdy_pdf[['name', 'status', 'address_components', 'formatted_address',
       'formatted_phone_number', 'geometry', 'icon',
       'international_phone_number', 'opening_hours', 'photos', 'rating',
       'reviews', 'types', 'url', 'vicinity', 'website', 'lng', 'lat', 'tmp',
       'date', 'hour', 'capacity', 'num_users']]
